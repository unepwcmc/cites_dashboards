...
FROM
  (SELECT shipment_year, taxon_group, reporter_type, term_code_1,unit_code_1,source_code,import_country_code,export_country_code, taxon_concepts_id, quantity_1,
    ...
    code.taxon_concepts_id as taxon_concepts_id, code.taxon_group, term_code_1,unit_code_1,code.full_name,
...
from national_detail n
  ...
  inner join new_taxon_code code on n.taxon_concept_id = code.taxon_concepts_id
...
and EXISTS (SELECT * FROM top_species inner join new_taxon_code c on top_species.taxon_concepts_id = c.taxon_concepts_id 
where c.taxon_concepts_id = n.taxon_concept_id and n.shipment_year BETWEEN top_species.shipment_year - 5 and top_species.shipment_year)
group by n.shipment_year,appendix,origin_country_code,n.reporter_type,n.import_country_code,n.export_country_code,
term_code_1,unit_code_1,n.source_code,n.purpose_code, code.taxon_group, code.taxon_concepts_id,code.full_name;

...
) TO '/tmp/export_national_1990_dec_2014.csv' WITH CSV;
...
COPY(
  ...
  group by reporter_type,
         ...
         tc.id AS taxon_concept_id
  order by reporter_type, year
) TO '/tmp/export_national_1990_2000_dec_2014.csv' WITH CSV;
...
COPY(
  ...
  group by reporter_type,
         ...
         tc.id AS taxon_concept_id
  order by reporter_type, year
) TO '/tmp/export_national_2000_2010_dec_2014.csv' WITH CSV;
...
COPY(
  ...
  group by reporter_type,
         ...
         tc.id AS taxon_concept_id
  order by reporter_type, year
) TO '/tmp/export_national_2010_dec_2014.csv' WITH CSV;
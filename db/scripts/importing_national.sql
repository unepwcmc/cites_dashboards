...
copy national_detail (
  ...
  kingdom_name,
  taxon_concept_id
) from '/tmp/export_national_1990.csv' delimiters ',' csv;
copy national_detail (
  reporter_type,
  shipment_year,
  appendix,
  ...
  kingdom_name,
  taxon_concept_id
) from '/tmp/export_national_1990_2000.csv' delimiters ',' csv;
copy national_detail (
  reporter_type,
  shipment_year,
  appendix,
  ...
  kingdom_name,
  taxon_concept_id
) from '/tmp/export_national_2000_2010.csv' delimiters ',' csv;
copy national_detail (
  reporter_type,
  shipment_year,
  appendix,
  ...
  kingdom_name,
  taxon_concept_id
) from '/tmp/export_national_2010.csv' delimiters ',' csv;

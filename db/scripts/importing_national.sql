...
copy national_detail (
  ...
  kingdom_name,
  taxon_concept_id
) from '/tmp/export_national_1990_oct_2015.csv' delimiters ',' csv;
copy national_detail (
  reporter_type,
  shipment_year,
  appendix,
  ...
  kingdom_name,
  taxon_concept_id
) from '/tmp/export_national_1990_2000_oct_2015.csv' delimiters ',' csv;
copy national_detail (
  reporter_type,
  shipment_year,
  appendix,
  ...
  kingdom_name,
  taxon_concept_id
) from '/tmp/export_national_2000_2010_oct_2015.csv' delimiters ',' csv;
copy national_detail (
  reporter_type,
  shipment_year,
  appendix,
  ...
  kingdom_name,
  taxon_concept_id
) from '/tmp/export_national_2010_oct_2015.csv' delimiters ',' csv;
